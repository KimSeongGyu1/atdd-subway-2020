...
public class PathAcceptanceStep {
    ...
    public static ExtractableResponse<Response> 거리_경로_조회_요청_로그인(String type, long source, long target,
    ...
    public static void 총_거리와_소요_시간과_요금을_함께_응답함(ExtractableResponse<Response> response, int totalDistance,
